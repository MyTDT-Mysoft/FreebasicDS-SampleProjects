namespace cpu
  ...
  sub fnAddr_Unimplemented()
    _Begin    
      color 12 : puts("Unimplemented Address: " & hex(.bOpcode,2) & " > '"+g_zDism(.bOpcode)+"'")
      .bBreak = 1
    _End
  end sub
  sub fnAddr__x_()
    _Begin  
      color 12 : puts("Addressing from illegal opcode: " & hex(.bOpcode,2))
      .bBreak = 1
    _End
  end sub
