...
declare sub d3Matrix_Translate(M as number ptr, X as const number, Y as const number, Z as const number )
...
declare sub d3Matrix_Scale( Matrix as number ptr, Scalarx as const number, byref Scalary as number, byref Scalarz as number )
